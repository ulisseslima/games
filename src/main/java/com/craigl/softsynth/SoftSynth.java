...
public class SoftSynth {
	...
	private Note[] song = { new Note(0, 2), new Note(60, 2), new Note(72, 2),
			new Note(71, 4), new Note(67, 8), new Note(69, 8), new Note(71, 4),
			new Note(72, 4), new Note(60, 2), new Note(69, 2), new Note(67, 1),
	 ...
	 * 
	 * @param args
	 *            A single numeric digit is expected which determines<br>
	 *            which example to run. Valid values are 1 .. 7 at the present
	 *            time.
	 */
