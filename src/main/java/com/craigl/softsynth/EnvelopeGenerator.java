...
public class EnvelopeGenerator {
	...
	public void addAttackTime(int ms) {
		setAttackTimeInMS(attackTime + ms);
	}
	...
	public void addDecayTime(int ms) {
		setDecayTimeInMS(decayMS + ms);
	}
	...
	public void addSustainLevel(double level) {
		setSustainLevel(sustainLevel + level);
	}
	 ...
	 * @since 22/09/2013
	 */
	public void addReleaseTime(int ms) {
		setReleaseTimeInMS(releaseMS + ms);
	}
